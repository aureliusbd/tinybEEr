/*!
 * @file  tinybEEr_TCS34725.h
 * @brief A library of color sensors
 */

#ifndef _tinybEEr_TCS34725_H_
#define _tinybEEr_TCS34725_H_
#ifdef __AVR
...
class tinybEEr_TCS34725 
{
  public:
	tinybEEr_TCS34725(TwoWire *pWire=&Wire, uint8_t I2C_addr = TCS34725_ADDRESS, eIntegrationTime_t = TCS34725_INTEGRATIONTIME_2_4MS, eGain_t = TCS34725_GAIN_1X);
	/**
	 * @fn begin
